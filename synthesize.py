...
if __name__ == "__main__":
    ...
    test_sentence=['안녕하세요 고객님 저는 에이에스 요금문의를 전문적으로 상담해드리는 에이아이 상담사입니다', '죄송합니다 말씀하신 내용을 확인할 수 없어 상담사 연결을 통해 안내 드리겠습니다', '이용해주셔서 감사합니다', '에이디티캡스 에이아이 상담 서비스는 이십사시간 다양한 문의를 상담 가능합니다.']
